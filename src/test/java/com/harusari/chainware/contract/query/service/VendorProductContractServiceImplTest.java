...
@DisplayName("[계약 조회 - query service] VendorProductContractServiceImpl 테스트")
class VendorProductContractServiceImplTest {
    ...
    @Test
    @DisplayName("[계약 전체 목록 조회] 관리자 권한자로 전체 계약 목록 조회 성공")
    ...
    @Test
    @DisplayName("[계약 전체 목록 조회] 일반 사용자는 vendorId 없이 조회 시 예외 발생")
    ...
    @Test
    @DisplayName("[계약 단건 조회] 관리자 권한자로 계약 조회 성공")
    ...
    @Test
    @DisplayName("[계약 단건 조회] 일반 사용자 매핑된 거래처 없으면 권한 예외 발생")
    ...
    @Test
    @DisplayName("[계약 단건 조회] 일반 사용자 계약 미존재 시 예외 발생")
    ...
    @Test
    @DisplayName("[계약 단건 조회] 일반 사용자 권한으로 계약 조회 성공")
