...
public enum AuthErrorCode {
    ...
    JWT_TOKEN_EMPTY_EXCEPTION("12006", "토큰이 비어있습니다.", HttpStatus.UNAUTHORIZED),
    INVALID_JWT_TOKEN_EXCEPTION("12007", "유효하지 않은 JWT 토큰입니다.", HttpStatus.UNAUTHORIZED),
    EXPIRED_JWT_TOKEN_EXCEPTION("12008", "만료된 JWT 토큰입니다.", HttpStatus.UNAUTHORIZED),
    UNSUPPORTED_JWT_TOKEN_EXCEPTION("12009", "지원하지 않는 JWT 토큰입니다.", HttpStatus.UNAUTHORIZED),
    EMPTY_JWT_CLAIMS_EXCEPTION("12010", "JWT 클레임이 비어 있습니다.", HttpStatus.UNAUTHORIZED);
