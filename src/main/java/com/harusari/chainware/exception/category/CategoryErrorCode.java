...
public enum CategoryErrorCode {
    ...
    TOP_CATEGORY_CANNOT_DELETE_HAS_PRODUCTS("20002","카테고리에 매핑된 제품이 있어 삭제할 수 없습니다.", HttpStatus.BAD_REQUEST),
    ...
    CATEGORY_CANNOT_DELETE_HAS_PRODUCTS("21002", "카테고리에 연결된 상품이 있어 삭제할 수 없습니다.", HttpStatus.BAD_REQUEST),
