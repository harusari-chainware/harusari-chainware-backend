...
public enum PurchaseOrderErrorCode {
    ...
    PURCHASE_REJECT_INVALID_STATUS("PO003", "현재 상태에서는 해당 작업을 수행할 수 없습니다.", HttpStatus.BAD_REQUEST),
    PURCHASE_CANCEL_INVALID_STATUS("PO004", "현재 상태에서는 해당 작업을 수행할 수 없습니다.", HttpStatus.BAD_REQUEST),
    PURCHASE_UNAUTHORIZED_VENDOR("PO005", "해당 발주의 거래처 담당자가 아닙니다.", HttpStatus.FORBIDDEN),
    PURCHASE_UNAUTHORIZED_WRITER("PO006", "발주를 취소할 권한이 없습니다.", HttpStatus.FORBIDDEN);
